...
#this for loop iterates through my momentum values and grabs the corresponding testing accuracy
#for this i choose to keep the arg_d and arg_wd to an arbitrary value of 0 as to see what would the
#momentums do without any interference
for arg_m in mymomentums:
...
plt.title('Test Accuracy vs different values of M')
plt.plot(mymomentums, test_results, 'r-', label="Momentum")
plt.legend(loc="upper left")
plt.xlabel("Size of Momentum")
