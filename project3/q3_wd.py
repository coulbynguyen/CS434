...
#this for loop iterates through my weight decay values and grabs the corresponding testing accuracy
#for this i choose to keep the arg_m and arg_d to an arbitrary value of 0 as to see what would the
#weight decays do without any interference
for arg_wd in myweight_decays:
...
plt.title('Test Accuracy vs different values of WD')
plt.plot(myweight_decays, test_results, 'r-', label="Weight Decay")
plt.legend(loc="upper left")
plt.xlabel("Size of Weight Decay")
