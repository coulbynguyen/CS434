...
#get the command line arguments for the set number of Dropout
#get the command line argument for the set number of momentum
#get the command line argument for the set number of weight decay
...
#here we keep it to the relu activation function
    def forward(self, x):
        x = x.view(-1, 32*32)
        x = F.relu(self.fc1(x))
        x = self.fc1_drop(x)
...
#this plots the graph of loss vs # of epochs for the changed variables of m / d/wd
